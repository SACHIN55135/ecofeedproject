...
# Ensure Git directories are added to path for the active shell session
$env:PATH += ";C:\Program Files\Git\cmd;C:\Program Files (x86)\Git\cmd;C:\Users\user\AppData\Local\Programs\Git\cmd"
...
git config user.email "donor@lapiazza.com"
git config user.name "SACHIN55135"
...
# 6. Add Remote origin
$remoteUrl = "https://github.com/SACHIN55135/ecofeedproject.git"
...
Write-Host "NOTE: Git will open a login window/browser tab for your GitHub authentication." -ForegroundColor Yellow
Write-Host ""
...
Write-Host ""
Write-Host "=============================================" -ForegroundColor Green
Write-Host "Finished! Check your repo: https://github.com/SACHIN55135/ecofeedproject" -ForegroundColor Green
Write-Host "=============================================" -ForegroundColor Green
Write-Host ""
